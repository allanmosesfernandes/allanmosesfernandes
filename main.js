...
function init() {
  ...
  var options = {
    ...
    strings: [
      "$ mkdir <em>new_project</em>^1000<br>`$ cd <em>new_project</em><br>`$ npm init -y<br>`$ cd touch <em>index.html</em><br>`$",
    ],
    typeSpeed: 100,
    backSpeed: 0,
    loop: true,
...
const checkboxer = document.getElementById("lighter");
checkboxer.addEventListener("change", replaceClass);
let element = document.getElementById("fullpage");
let orangeHover = Array.from(document.querySelectorAll(".orange-hover"));
let icons = Array.from(document.querySelectorAll(".enjoy-img-dark"));
